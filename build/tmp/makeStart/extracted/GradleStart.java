...
public class GradleStart extends GradleStartCommon {
    ...
    protected void setDefaultArguments(Map<String, String> argMap) {
        ...
        argMap.put("assetsDir", "C:/Users/Paul/.gradle/caches/minecraft/assets");
    ...
    private static void hackNatives() {
        ...
        String nativesDir = "C:/Users/Paul/.gradle/caches/minecraft/net/minecraft/minecraft_natives/1.7.10";
    ...
    private void attemptLogin(Map<String, String> argMap) {
        ...
        argMap.put("userProperties", new GsonBuilder().registerTypeAdapter(com.mojang.authlib.properties.PropertyMap.class, new net.minecraftforge.gradle.OldPropertyMapSerializer()).create().toJson(auth.getUserProperties()));
    }
